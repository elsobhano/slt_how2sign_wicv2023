...
# --- swept: weight_decay x label_smoothing (LR + dropout fixed at Phase-1 base) ---
WD=0.0
LS=0.1
LR=1e-3
DP=0.3
...
apptainer exec "$IMAGE" bash -lc "
    ...
    python -m fairseq_cli.hydra_train \
        ...
        optimizer.weight_decay=$WD criterion.label_smoothing=$LS
"
